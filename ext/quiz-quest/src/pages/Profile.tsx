...
const Profile = () => {
  ...
  const achievements = [
    ...
    { title: "Sequência de 5", description: "5 problemas corretos seguidos", earned: true },
    { title: "Especialista Nível 1", description: "10 problemas de dificuldade 1", earned: true },
    { title: "Sequência de 10", description: "10 problemas corretos seguidos", earned: false },
  ];
          ...
          <CardContent className="space-y-6">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-sm text-gray-600">Membro desde {user.joinDate}</span>
              </div>
            </div>
